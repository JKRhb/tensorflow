...
# Compile the binary
make -f tensorflow/lite/micro/tools/make/Makefile TARGET=sparkfun_edge TAGS=cmsis-nn person_detection_bin

# Sign the binary
python3 tensorflow/lite/micro/tools/make/downloads/AmbiqSuite-Rel2.2.0/tools/apollo3_scripts/create_cust_image_blob.py --bin tensorflow/lite/micro/tools/make/gen/sparkfun_edge_cortex-m4/bin/person_detection.bin --load-address 0xC000 --magic-num 0xCB -o main_nonsecure_ota --version 0x0
